/**
 * 1_smoke_stage1_reflow1.ino — Kompic Mk I, first board smoke test
 *
 * Refactored 2026-07-05 as part of the Stage 5 close-out. Renamed from
 * 1_smoke_test_mk1_reflow1 in the pre-refactor legacy set. See
 * hardware/Reflow_info/Stage_5_Build_Report.md for context.
 *
 * WHEN TO USE: verify the initial Stage-1 reflow of a freshly-fabbed Mk I
 * board -- ESP32-S3 booting, BQ25619 alive, RTC ticking. No battery yet at
 * this stage, so this sketch intentionally does NOT include a ship-mode
 * double-click handler. If you flash it to a battery-attached board,
 * either keep USB connected the whole time OR add the ship-mode block from
 * 3_smoke_stage3_full first.
 *
