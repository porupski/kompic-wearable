...
#define MAX30101_DRIVER_VERSION  "0.2.0"
#include <stdint.h>
#include <stdbool.h>
#include "esp_err.h"
...
#define MAX30101_ADC_16384          0x03
...
// Original values (IR-at-7mA-on-finger heritage from the MAX30102 driver):
//   FINGER = 50000, BEAT = 1000
// Loosened for wrist-worn green PPG @ 30 mA (§ 7.4 of Stage_6_Build_Report):
//   The DC channel intensity is highly variable on the wrist due to
//   perfusion / motion / strap tension. 5000 catches typical wrist DC
//   while still gating out "sensor uncovered" (which reads a few hundred).
//   Beat threshold lowered proportionally.
#define MAX30101_IR_FINGER_THRESHOLD  5000U
#define MAX30101_BEAT_THRESHOLD       200
#define MAX30101_MIN_BPM              30
#define MAX30101_MAX_BPM              220
